export const zhCN = {
  ...
  pathReference: {
    ...
    session: '会话',
    task: '任务',
    loadingFiles: '正在读取当前目录…',
    loadingSessions: '正在读取会话…',
    pathOutside: '路径必须位于当前工作目录内',
    loadFilesFailed: '目录读取失败',
    ...
    enter: '进入',
    enterFolderLabel: '进入文件夹 {{path}}',
    hint: 'Enter 引用 · Right/Tab 进入文件夹 · Esc 关闭',
  },
};
