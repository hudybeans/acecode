export const enUS = {
  ...
  commands: {
    ...
    descriptions: {
      ...
      turn: 'Interject into the active turn before its next model call',
      btw: 'Open side chat for questions and follow-ups',
  ...
  pathReference: {
    ariaLabel: 'File, folder, and session references',
    files: 'Files',
    sessions: 'Sessions',
    file: 'File',
    folder: 'Folder',
    session: 'Session',
    task: 'Task',
    loadingFiles: 'Reading the current directory…',
    loadingSessions: 'Loading sessions…',
    pathOutside: 'The path must be within the current working directory',
    loadFilesFailed: 'Failed to read the directory',
    ...
    enter: 'Enter',
    enterFolderLabel: 'Enter folder {{path}}',
    hint: 'Enter to reference · Right/Tab to enter folder · Esc to close',
  },
};
