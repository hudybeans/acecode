  ...
  return (
    <>
      ...
      <button
        ...
        className={clsx(
          'ace-sidebar-extensions-trigger ace-sidebar-primary-text w-full flex items-center gap-[7px] pl-[9px] pr-[13px] py-[3px] rounded-md text-[14px] text-fg hover:bg-surface-hi transition',
