...
function WorkspaceGroup({
  ...
  return (
    <div className={clsx(ws.active && 'rounded-md')}>
      <div
        ...
        className={clsx(
          'ace-sidebar-workspace-row ace-sidebar-tree-row-grid ace-sidebar-primary-text group grid grid-cols-[24px_minmax(0,1fr)_76px] items-center gap-x-[7px] mx-1.5 pl-[13px] pr-2 h-8 rounded-md text-[14px] cursor-pointer transition',
      ...
      >
        ...
        {editing ? (
          ...
          <span className={clsx('ace-sidebar-tree-content min-w-0 truncate', hasUnread ? 'font-semibold' : 'font-normal')}>
            {ws.name || ws.hash}
          </span>
        )}
        <span data-sidebar-workspace-actions="true" className="flex w-full items-center justify-end gap-1 shrink-0">
              ...
              {projectedSessions.collapsible && (
                <div className="ace-sidebar-tree-row-grid grid grid-cols-[24px_minmax(0,1fr)_76px] items-center gap-x-[7px] mx-1.5 pl-[13px] pr-2">
                  ...
                  <button
                    ...
                    className="ace-sidebar-tree-content ace-sidebar-meta-text px-0 py-[5px] rounded-md text-left text-[13px] text-fg-mute hover:text-fg transition"
                  >
          ...
          {projectedSessions.collapsible && (
            <div className="ace-sidebar-tree-row-grid grid grid-cols-[24px_minmax(0,1fr)_76px] items-center gap-x-[7px] mx-1.5 pl-[13px] pr-2">
              ...
              <button
                ...
                className="ace-sidebar-meta-text py-[5px] rounded-md text-left text-[13px] text-fg-mute hover:text-fg transition"
              >
                {projectedSessions.action === 'expand' ? '展开显示' : '折叠显示'}
              </button>
            </div>
      ...
      <div className="ace-sidebar-content flex-1 flex flex-col min-h-0">
        ...
        <div className="ace-sidebar-main flex-1 flex flex-col min-h-0">
          ...
          <div
            ...
            className="ace-sidebar-scroll flex-1 overflow-y-auto"
