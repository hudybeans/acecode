...
constexpr Catalog kZhCn = {
    ...
    "导出会话",
    "保存",
    "未找到文件保存工具：请安装 zenity（如 sudo apt install zenity）或 kdialog 后重试",
    "无法打开会话另存为对话框，请重试",
    "Markdown 文件 (*.md)",
    "导出主题",
    "无法打开主题另存为对话框，请重试",
...
constexpr Catalog kEnUs = {
    ...
    "Export session",
    "Save",
    "No file save dialog was found. Install zenity (for example, sudo apt install zenity) or kdialog and try again.",
    "Unable to open the session Save As dialog. Try again.",
    "Markdown files (*.md)",
    "Export theme",
    "Unable to open the theme Save As dialog. Try again.",
    "Theme package (*.zip)",
