...
and standalone tests are imported unchanged; the build script is adapted for
production. No local release binaries or prebuilt payloads are used.
...
The first command runs engine fault/rollback tests with assertions enabled and
