#!/usr/bin/env bash
# Build a generic Intel macOS portable ACECode package.
# Usage: scripts/build_macos_x64.sh [suffix]
set -euo pipefail
...
Builds a generic Intel (x86_64) macOS portable ZIP.
The default output is dist/acecode-<version>-macos-x86_64-release-portable.zip.
...
output="$repo_root/dist/acecode-${version}-macos-x86_64-${suffix}-portable.zip"
